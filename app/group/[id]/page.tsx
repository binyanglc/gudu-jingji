...
const PITCH_GUIDE = [
  {
    ...
    title: "The Problem",
    titleZh: "需求 & 问题",
    hint: "What problem do young people living alone face? How many people have this need?",
    hintZh: "空巢青年有什么问题？多少人有这样的需求？",
  },
  {
    step: 2,
    title: "Your Solution",
    titleZh: "你的产品 / 服务",
    hint: "What is your product or service called? Describe it in one sentence.",
    hintZh: "你的产品或者服务叫什么？用一句话介绍它。",
  },
  {
    step: 3,
    title: "Key Features",
    titleZh: "功能 & 特点",
    hint: "What's special about it? What can people do with your product or service?",
    hintZh: "你的产品或服务有什么特别的？人们可以用它来做什么？",
  },
  {
    step: 4,
    title: "Impact",
...
const SAMPLE_TEXT = `大家有没有想过，一个人去餐厅吃饭是什么感觉？很多人觉得一个人吃饭很不好意思。我们采访了10个人，超过一半的人都有这样的问题。可见，这个需求很大。

所以，我们设计了一个一人食餐厅，叫"不孤单"。

它最大的特点是：除了可以一个人安静地吃饭以外，每个座位还有一个小机器人陪你聊天。

用了以后会怎么样呢？很多消费者说，一点儿都不觉得孤独了！甚至觉得一个人吃饭比跟朋友吃饭还自在。

如果你也一个人吃饭，来试试"不孤单"吧！谢谢大家！`;
...
export default function GroupWorkspace() {
  ...
  async function handleGenerate() {
    if (!productName.trim()) {
      setError("Please fill in the product / service name.");
      return;
    }
